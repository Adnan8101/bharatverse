...
export default function Cart() {
    ...
    const handleApplyCoupon = async () => {
        ...
        try {
            // Prepare cart items with store information
            const cartItemsWithStore = cartArray.map(item => ({
                productId: item.id,
            ...
            const response = await fetch('/api/coupons/validate', {
                ...
                body: JSON.stringify({
                    code: tempCouponCode.trim(),
                    cartItems: cartItemsWithStore
                })
            });
            ...
            if (result.success) {
                dispatch(applyCoupon({
                    ...
                    code: tempCouponCode.trim().toUpperCase(),
                    applicableItems: result.data.applicableItems,
                                    ...
                                    <div className="space-y-4 mb-6">
                                        ...
                                        {couponDiscount > 0 && (
                                            <div className="flex justify-between text-green-600">
                                                ...
                                                <span>-{currency}{(couponDiscount || 0).toLocaleString()}</span>
                                            </div>
                                        )}
                                            ...
                                            <div className="space-y-3">
                                                <div className="flex gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={couponLoading || !tempCouponCode.trim()}
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-3 text-green-700">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-green-600">-{currency}{(couponDiscount || 0).toLocaleString()} saved!</p>
                                                            {appliedCoupon?.isStoreCoupon && (
                                                                <p className="text-xs text-green-600">
                                                                    Valid for {appliedCoupon.storeName} products only
                                                                </p>
                                                            )}
                                                        </div>
                                                    </div>
