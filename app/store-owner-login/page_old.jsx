...
import { Store, User, Eye, EyeOff, Clock, CheckCircle, XCircle, ArrowLeft, Mail, Lock } from 'lucide-react';
    ...
    try {
      ...
      if (data.success) {
        if (data.store.status === 'pending') {
          ...
          // Store is approved, redirect to dashboard
          router.push('/store');
        } else if (data.store.status === 'rejected') {
          setError('Your store application has been rejected. Please contact support for more information.');
        }
      } else {
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="email"
                  required
                  className="appearance-none relative block w-full px-12 py-3 border border-gray-700 placeholder-gray-400 text-white bg-gray-800 rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type={showPassword ? 'text' : 'password'}
                  required
                  className="appearance-none relative block w-full px-12 py-3 border border-gray-700 placeholder-gray-400 text-white bg-gray-800 rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm pr-12"
          ...
          <div className="text-center">
            <p className="text-xs text-gray-400">
              Don't have a store? <a href="/create-store" className="text-blue-400 hover:text-blue-300">Apply here</a>
            </p>
          </div>
        </form>
      </div>
