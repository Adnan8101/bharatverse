...
import { Home, ShieldCheck, Store, Percent, MessageSquare, Tag, PackageCheck } from "lucide-react"
...
const AdminSidebar = () => {
    ...
    const sidebarLinks = [
        ...
        { name: 'Product Approval', href: '/admin/products', icon: PackageCheck },
        ...
        { name: 'Store Coupons', href: '/admin/store-coupons', icon: Tag  },
    ]
    ...
    return (
        <div className="inline-flex h-full flex-col gap-5 border-r border-slate-200 sm:min-w-60">
            <div className="flex flex-col gap-3 justify-center items-center pt-8 max-sm:hidden">
                ...
                <p className="text-slate-700">Hi, Adnan & Harsh</p>
            </div>
