'use client'
import { ShoppingCart, User, LogIn, X, Store, Shield, Clock } from "lucide-react";
...
const Navbar = () => {
    ...
    const isGuestWithItems = isLoaded && !user && cartCount > 0
                    ...
                    <div className="flex items-center justify-between max-w-7xl mx-auto py-4 transition-all">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <Link href="/cart" className="relative flex items-center gap-2 px-3 py-2 text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded-lg transition-colors">
                                ...
                                {isGuestWithItems && (
                                    <div className="absolute -bottom-1 -right-1" title="Cart items will be saved when you sign in">
                                        <Clock size={12} className="text-amber-500 bg-white rounded-full p-0.5" />
                                    </div>
                                )}
                            </Link>
