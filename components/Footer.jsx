...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "8433654302", path: '/', icon: PhoneIcon },
                { text: "adnanqureshi8101@gmail.com", path: '/', icon: Mail },
                { text: "Mumbai, Maharashtra", path: '/', icon: MapPin }
            ]
        }
    ];
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="flex items-center gap-2">
                            <img src="/bharatverse-logo.png" alt="BharatVerse" className="h-10 w-10" />
                            <span className="text-3xl font-semibold text-slate-700">
                                <span className="text-orange-600">Bharat</span><span className="text-green-600">Verse</span>
                            </span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to BharatVerse, where art meets culture. Discover exquisite handcrafted treasures, traditional artwork, and authentic Indian cultural products that celebrate our rich heritage and support local artisans.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © BharatVerse All Right Reserved. Developed by Adnan Qureshi & Harsh
                </p>
            </div>
        </footer>
    );
